...
public abstract class AbstractEncoder implements Encoder{
	...
	private long getSeq(Object msg){
		...
		}else if(msg instanceof DPSFProtos.Request){
			DPSFProtos.Request msg_ = (DPSFProtos.Request)msg;
			seq = msg_.getTransferId();
		}else if(msg instanceof DPSFProtos.Response){
			DPSFProtos.Response msg_ = (DPSFProtos.Response)msg;
			seq = msg_.getTransferId();
		}else if(msg instanceof com.dianping.dpsf.protocol.thrift.Request){
			com.dianping.dpsf.protocol.thrift.Request msg_ = (com.dianping.dpsf.protocol.thrift.Request)msg;
			seq = msg_.getTransferId();
		}else if(msg instanceof com.dianping.dpsf.protocol.thrift.Response){
			com.dianping.dpsf.protocol.thrift.Response msg_ = (com.dianping.dpsf.protocol.thrift.Response)msg;
			seq = msg_.getTransferId();
		}
		return seq;
	}

...
public class RequestExecutor implements Runnable {
    ...
    public RequestExecutor(DPSFRequest request, Channel channel, RequestProcessor processor) {
        this.request = request;
        this.channel = channel;
        this.serviceRepository = processor.getServiceRepository();
    ...
    private DPSFResponse doBusiness() {
        ...
        try {
            method = this.serviceRepository.getMethod(request.getServiceName(), request.getMethodName(), request.getParamClassName());
